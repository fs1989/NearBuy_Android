...
import com.insthub.nearbuy.adapter.B1_ProductListAdapter;
import com.insthub.nearbuy.adapter.GoodListLargeListActivityAdapter;
import com.insthub.nearbuy.model.GoodsListModel;
...
import com.insthub.nearbuy.protocol.PAGINATED;
       ...
       final LinearLayout mainView = (LinearLayout) findViewById(R.id.keyboardLayout1);
        ...
        if (null != filter_string)
        {
            try
            {
                ...
                filter =new com.insthub.nearbuy.protocol.FILTER();
            ...
            case 1:
            {
                if(null != data)
                {
                    ...
                    if (null != filter_string)
                    {
                        ...
                        {
                            JSONObject filterJSONObject = new JSONObject(filter_string);
                            FILTER filter = new com.insthub.nearbuy.protocol.FILTER();
                            filter.fromJson(filterJSONObject);
