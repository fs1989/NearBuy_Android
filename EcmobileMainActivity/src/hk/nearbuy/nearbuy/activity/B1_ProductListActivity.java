...
import hk.nearbuy.nearbuy.adapter.B1_ProductListAdapter;
import hk.nearbuy.nearbuy.adapter.GoodListLargeListActivityAdapter;
import hk.nearbuy.nearbuy.model.GoodsListModel;
...
import hk.nearbuy.nearbuy.protocol.PAGINATED;
       ...
       final LinearLayout mainView = (LinearLayout) findViewById(R.id.keyboardLayout1);
        ...
        if (null != filter_string)
        {
            try
            {
                ...
                filter =new hk.nearbuy.nearbuy.protocol.FILTER();
            ...
            case 1:
            {
                if(null != data)
                {
                    ...
                    if (null != filter_string)
                    {
                        ...
                        {
                            JSONObject filterJSONObject = new JSONObject(filter_string);
                            FILTER filter = new hk.nearbuy.nearbuy.protocol.FILTER();
                            filter.fromJson(filterJSONObject);
